...
Home: I worked on getting the quitting code to work more elegantly, so now you can resume or quit. I also fixed the history code so that it shows all of the usernames! i also fixed the break in the code that happened if there were no saved chats. Did more testing and included the bugs in readme!
